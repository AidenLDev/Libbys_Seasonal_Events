upgrades = {
    ...
    { name = "Bullet Resistance", unit = "", description = "% Damage reduction", defaultDescription = "Reduce incoming damage from bullet-type weapons", baseCost = 21, maxLevel = 5, valuePerLevel = 10 },
